...
class BalanceTest {
  ...
  void testToString() {
    ...
    Assertions.assertEquals(
        "Balance[updated=<null>,balance=<null>,balanceString=<null>,totalReceived=<null>,totalSent=<null>,balanceString=<null>,confirmedBalanceString=<null>,spendableBalanceString=<null>,coin=<null>]",
        result);
  }
