...
class UnstakingOptionsTest {
    UnstakingOptions unstakingOptions= new UnstakingOptions("from", "receiver", "unstakeCpuQuantity", "unstakeNetQuantity");

    @Test
    void testToString(){
        String result = unstakingOptions.toString();
        Assertions.assertEquals("UnstakingOptions[from=from,receiver=receiver,unstakeCpuQuantity=unstakeCpuQuantity,unstakeNetQuantity=unstakeNetQuantity]", result);
    }
